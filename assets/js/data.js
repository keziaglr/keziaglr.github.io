const data = [
    {
      ...
      "name": "PONO",
      "type": "Mobile",
      "icon": "assets/img/portfolio/PONO Logo.png",
      "cover": "assets/img/portfolio/PONO Portfolio.png",
      "desc": ["Dyslexic children encounter challenges in reading due to difficulties in phonological awareness, particularly in the critical skill of segmenting, where they actively separate words into syllables which is a crucial ability for developing reading and spelling skills.", "<b>PONO</b> is an educational app designed to foster foundational reading and pronunciation skills in children. PONO blends digital features with hands-on learning in syllables and word exploration, pronunciation practice, and syllables-from-word recognition activities."],
      "tasks": [
        ...
        "Displayed CoreData data on charts using SwiftChart.",
        "Conducted code reviews and approvals.",
        "Managed the learning flow responsibility."
      ],
      ...
      "tech": ["SwiftUI", "AVFoundation", "TensorFlow", "SwiftChart", "CoreData", "Speech-to-Text", "MVVM"]
        ...
        "name": "Pandawa",
        "type": "Game",
        "icon": "assets/img/portfolio/Pandawa Logo.png",
        "cover": "assets/img/portfolio/Pandawa Portfolio.png",
        "desc": ["By preserving endangered cultural art forms such as the traditional Indonesian Wayang, known for its captivating storytelling and puppetry, there is an opportunity to reimagine this ancient art using technology with realistic movements and interactions.", "<b>Pandawa</b> is a traditional Indonesian puppetry art form, through an interactive experience where users can play with Wayang characters. You can explore and learn about the five Pandawa characters, who represent positive traits and values."],
        "tasks": [
          "Conducted investigations for application ideas.",
          "Created illustrations for the application.",
          "Designed UI/UX elements.",
          "Created content for the app.",
        ...
        "links": [
          {
              "type": "WWDC23 Scholars",
              "link": "https://www.wwdcscholars.com/s/BAC7518D-C763-4996-A3C8-56A46BC032A9/2023"
          },{
              "type": "GitHub",
        ...
        "tasks": [
            "Conducted team investigations for application ideas.",
            "Assigned tasks and guided team as a tech lead.",
            "Developed authentication features with Firebase Auth.",
            "Developed chatroom, profile, and badges features.",
            "Conducted code reviews and approvals.",
            "Managed the app flow responsibility."
        ],
        ...
        "tasks": [
          ...
          "Assigned tasks and guided team as a tech lead.",
          "Developed 3 games.",
          "Developed map, platyroll, and profile features with CoreData.",
          "Conducted user testing.",
          "Managed the app flow responsibility."
        ],
        ...
        "name": "Tower Block",
        "type": "Game",
        "icon": "assets/img/portfolio/Tower Block Logo.png",
        "cover": "assets/img/portfolio/Tower Block Portfolio.png",
        "desc": ["<b>Tower Block</b> is designed for players who enjoy nostalgic gaming experiences and seek a challenging gameplay that caters to individuals of all ages who appreciate building and strategy games, offering a fun and addictive experience."],
        "tasks": [
            "Conducted investigations for application ideas.",
            "Created illustrations for the application.",
            "Designed UI/UX elements.",
        ...
        "name": "Golden Bakery",
        "type": "Mobile",
        "icon": "assets/img/portfolio/Golden Bakery Logo.png",
        "cover": "assets/img/portfolio/Golden Bakery Portfolio.png",
        "desc": ["<b>Golden Bakery</b> is a flutter app designed to seamlessly showcase bakery's diverse and delectable range of products, ensuring a delightful browsing experience. Through Golden Bakery, users can explore a diverse menu, share their thoughts via reviews, and customize their experience by toggling between dark mode and light mode."],
        "tasks": [
            "Designed UI/UX elements.",
            "Coded functionalities for the application.",
        ],
        ...
        "links": [
          {
              "type": "GitHub",
              "link": "https://github.com/keziaglr/golden-bakery"
          }
        ],
        "tech": ["Flutter"]
      },{
        ...
        "name": "KZkin",
        "type": "Mobile",
        "icon": "assets/img/portfolio/KZkin Logo.png",
        "cover": "assets/img/portfolio/KZkin Portfolio.png",
        "desc": ["<b>KZkin</b> is an android application designed for reviewing beauty products, enabling users to generate their own critiques and express approval for reviews posted by others. Additionally, users receive notifications when their reviews are liked by fellow users."],
        "tasks": [
            "Conducted investigations for application ideas.",
            "Designed UI/UX elements.",
            "Coded functionalities for the application.",
        ...
        "links": [
            {
                ...
                "link": "https://github.com/keziaglr/frontend-tohopedia"
            },{
                "type": "GitHub (Backend)",
                "link": "https://github.com/keziaglr/backend-tohopedia"
            }
        ],
        "tech": ["Go", "GraphQL", "ReactJS", "MySQL"]
    },{
        "id": 8,
        "name": "Online Florist",
        "type": "Web",
        ...
        "links": [
            {
                "type": "GitHub",
                "link": "https://github.com/keziaglr/online-florist"
            }
        ],
        "tech": ["PHP", "Laravel", "MySQL"]
    },{
        "id": 9,
        "name": "The Adventure of Lorenzo",
        "type": "Game",
        ...
        "links": [
            {
                "type": "GitHub",
                "link": "https://github.com/keziaglr/the-adventure-of-lorenzo"
            }
        ],
        "tech": ["Unity", "C#"]
    },{
        ...
        "links": [
            {
                "type": "GitHub",
                "link": "https://github.com/keziaglr/bee-portal"
            }
        ],
        "tech": ["Electron", "Firebase", "Visual Paradigm"]
    },{
        "id": 11,
        "name": "BeeCara",
        "type": "Web",
        ...
        "links": [
            {
                "type": "GitHub",
                "link": "https://github.com/keziaglr/beecara"
            }
        ],
        ...
        "links": [
            {
                "type": "GitHub",
                "link": "https://github.com/keziaglr/laptop-store"
            }
        ],
